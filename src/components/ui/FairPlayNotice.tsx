...
const FairPlayNotice: React.FC = () => {
  return (
    <div className="fixed left-4 right-4 bottom-6 z-50 flex justify-center pointer-events-none">
      <div className="pointer-events-auto max-w-3xl w-full p-4 bg-card/80 border border-border rounded-lg shadow-lg glass-card backdrop-blur-md flex items-center gap-4">
